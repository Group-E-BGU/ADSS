...
public class InitializeData {
    ...
    public void createShifts() {
        ...
        Date date = new Date();
        Worker w = blService.getWorker(111111111);
...
//            Address yafo = blService.getAddress("Yafo");
            ...
            Shift sh = new Shift(haifa,date, Shift.ShiftTime.Morning,w,new HashMap<>());
            blService.addShift(sh);
//            Date one_week = addWeek(date,1);
//            Shift sh1 = new Shift(haifa,date, Shift.ShiftTime.Evening,w,new HashMap<>());
//            blService.addShift(sh1);
//            one_week = addWeek(date,1);
//            Shift sh2 = new Shift(haifa,date, Shift.ShiftTime.Evening,w,new HashMap<>());
//            blService.addShift(sh2);
//            one_week = addWeek(date,1);
//            Shift sh3 = new Shift(haifa,date, Shift.ShiftTime.Evening,w,new HashMap<>());
//            blService.addShift(sh3);
//            one_week = addWeek(date,1);
//            Shift sh4 = new Shift(haifa,date, Shift.ShiftTime.Morning,w,new HashMap<>());
//            blService.addShift(sh4);
//            one_week = addWeek(date,1);
//            Shift sh5 = new Shift(haifa,date, Shift.ShiftTime.Evening,w,new HashMap<>());
//            blService.addShift(sh5);
        } catch (ParseException pe) {
            pe.printStackTrace();
        }
 ...
 */
    ...
    public Date addWeek(Date curr_date , int amount) {
    ...
    public boolean preventExampleDup() {

        return BLService.getInstance().getAllShifts().size() !=0;
